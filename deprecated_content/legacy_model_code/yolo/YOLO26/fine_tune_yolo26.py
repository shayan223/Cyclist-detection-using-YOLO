...
def fine_tune_yolo26(
    ...
    """Fine-tune a YOLO26 model with crowd/small-object recipe controls."""
...
def run_ablation_protocol(
    ...
    print("\nInference command templates for deepSORT_yolo26.py:")
    print("  # Ablation 3 (+top-region pass)")
    print("  python YOLO26/deepSORT_yolo26.py --model <weights.pt> --top-region-pass --top-region-ratio 0.45")
    print("  # Ablation 4 (+soft-nms)")
    print("  python YOLO26/deepSORT_yolo26.py --model <weights.pt> --top-region-pass --crowd-mode soft-nms --soft-nms-iou 0.25 --soft-nms-sigma 0.2")
    print("  # Ablation 5 (+tiled SAHI-style pass)")
    print("  python YOLO26/deepSORT_yolo26.py --model <weights.pt> --top-region-pass --crowd-mode soft-nms --tile-mode sahi --tile-size 480 --tile-overlap 0.6")
...
def main():
    ...
    parser.add_argument("--model", type=str, default=MODEL_PATH, help="Path to pretrained YOLO26 model/checkpoint.")
