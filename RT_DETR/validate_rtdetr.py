...
def validate(
    ...
    """Run validation on a fine-tuned RT-DETR model and print mAP metrics."""
...
def main():
    parser = argparse.ArgumentParser(description="Validate a fine-tuned RT-DETR model.")
    parser.add_argument("--model", "-m", type=str, default=DEFAULT_MODEL, help="Path to RT-DETR .pt checkpoint.")
